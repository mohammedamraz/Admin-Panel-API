...
import { AMRAZ_ACCOUNTID, AMRAZ_AUTHTOKEN, APP_DOWNLOAD_LINK, AWS_COGNITO_USER_CREATION_URL_SIT, FEDO_APP, PUBLIC_KEY, SALES_PARTNER_LINK, SALES_PARTNER_NOTIFICATION, TWILIO_PHONE_NUMBER, TWILIO_WHATSAPP_NUMBER, AMRAZ_SERVICEID } from 'src/constants';
