...
,  controllers: [ProfileInfoController],
  providers: [ProfileInfoService,ProductTestsService,VideoToVitalsService,ProductService, UserProductJunctionService, SendEmailService, TemplateService, OrganizationService,OrgProductJunctionService, UsersService]
})
