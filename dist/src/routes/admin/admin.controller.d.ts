...
export declare class AdminController {
    ...
    sendEmailOnCreationOfDirectSalesPartner(content: sendEmailOnCreationOfDirectSalesPartner): Promise<unknown>;
    sendEmailOnGreivanceRegressal(content: sendEmailOnCreationOfDirectSalesPartner): Promise<unknown>;
