import { LoginDTO, Period, SalesYearMonth, UpdateSalesPartner, YearMonthDto, ZQueryParamsDto } from './dto/create-sale.dto';
...
export declare class SalesController {
    ...
    fetchSalesCodeByMobileNumber(mobileDTO: LoginDTO): import("rxjs").Observable<import("../../lib/config/model/sales.model").CreateSalesPartnerModel[]>;
    ...
    uploadImage(id: string, file: any): Promise<import("rxjs").Observable<import("rxjs").Observable<import("../../lib/config/model/sales.model").CreateSalesPartnerModel[]>>>;
