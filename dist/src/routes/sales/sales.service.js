...
let SalesService = class SalesService {
    ...
    findUserByCustomerId(id) {
        common_1.Logger.debug(`findUserByMobileNumber() id: [${JSON.stringify(id)}]`, APP);
        return (0, rxjs_1.from)((0, rxjs_1.lastValueFrom)(this.db.find({ userreference_id: id }).pipe((0, rxjs_1.catchError)(err => { throw new common_1.UnprocessableEntityException(err.message); }), (0, rxjs_1.map)((res) => {
            if (res.length != 0)
    ...
    fetchuserbyCustomerId(id) {
        common_1.Logger.debug(`fetchuserbyCustomerId id:${id}`, APP);
        return (0, helper_1.findUserByCustomerId)(id).pipe((0, rxjs_1.map)(doc => {
            if (doc.length == 0)
