...
export declare const fetchAccountBySalesCode: (salesCode: string) => import("rxjs").Observable<AccountShort[]>;
export declare const findUserByCustomerId: (id: string) => import("rxjs").Observable<createAccount[]>;
