...
exports.HOST = process.env.FEDO_HSA_SALES_SERVER_HOST || '0.0.0.0';
exports.PORT = parseInt(process.env.FEDO_HSA_SALES_SERVER_PORT, 10) || 36000;
exports.APP_VERSION = package_json_1.default.version;
exports.DEBUG_LEVEL = process.env.FEDO_HSA_SALES_SERVER_LOG_LEVEL || 'debug';
exports.APP_DOCUMENTATION = process.env.FEDO_HSA_SERVER_DOCUMENTATION || 'https://fedo.health/hsa/docs';
exports.POSTGRES_DB_URI_DB_URL = process.env.FEDO_HSA_SALES_SERVER_DB_URI || 'postgresql://postgres:Fedo@1234@localhost:5432/HSA_Sales';
exports.AMRAZ_AUTHTOKEN = process.env.FEDO_HSA_SALES_TWILIO_AUTHTOKEN || "3a02e7cc85cc1f8b5ca011fd39c40c0e";
exports.AMRAZ_SERVICEID = process.env.FEDO_HSA_SALES_TWILIO_SERVICEID || "VAe2d6baceed7fe5b04fc546d4fa3560f8";
exports.AMRAZ_ACCOUNTID = process.env.FEDO_HSA_SALES_TWILIO_ACCOUNTID || "ACee7f5c43cad32fd3a589999f12548b19";
exports.TWILIO_PHONE_NUMBER = process.env.FEDO_HSA_SALES_TWILIO_PHONE_NUMBER || "+19784806237";
exports.TWILIO_WHATSAPP_NUMBER = process.env.FEDO_HSA_SALES_TWILIO_WHATSAPP_NUMBER || "+14155238886";
...
exports.AWS_ACCESS_KEY_ID = process.env.FEDO_HSA_SALES_AWS_ACCESS_KEY_ID || 'AKIAWVJICQ3FDBOB6CGC';
exports.AWS_SECRET_ACCESS_KEY = process.env.FEDO_HSA_SALES_AWS_SECRET_ACCESS_KEY || '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';
...
exports.FEDO_HSA_USER_CONNECTION_URL = process.env.FEDO_HSA_USER_CONNECTION_URL || 'http://0.0.0.0:35000/users/';
